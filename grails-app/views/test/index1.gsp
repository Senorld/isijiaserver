                ...
                <div class="chiefs">
                    ...
                    <div class="chief-avatar-block">
                        <div class="chief-avatar">
                            <img src="images/avatar1.jpg" class="round_photo">
                            <div class="avatar-name">王叉子	</div>
                        </div>
                        <div class="chief-avatar">
                            <img src="images/avatar2.jpg" class="round_photo">
                            <div class="avatar-name">甜甜圈不辣</div>
                        </div>
                        <div class="chief-avatar">
                            <img src="images/avatar3.jpg" class="round_photo">
                            <div class="avatar-name">果丹皮</div>
                        </div>
                    </div>
                </div>
                <div class="hot-chief-dishes">
